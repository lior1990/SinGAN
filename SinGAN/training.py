...
from SinGAN.my_functions import create_img_over_background, create_background, create_clustered_image
...
def train_single_scale(netD, netD_mask1, netD_mask2,netG,reals1, reals2, Gs,Zs,in_s1, in_s2,NoiseAmp,opt):
    ...
    if opt.extra_clustered:
        ...
        plt.imsave('%s/real1_clustered.png' % (opt.outf), real1_clustered, vmin=0, vmax=1)
        real1_clustered = functions.np2torch(real1_clustered, opt)
        # real2
